...
export const ProductList = () => {
  ...
  function addToCart(e, productId, product) {
    ...
    if (existingProductIndex !== -1) {
      if (inputQuantity[productId] > 0) {
        // Add product to cart or update existing product
      } else {
        console.warn("Quantity must be greater than zero to add to cart");
      }
  ...
  function preventDuplicateOfExistingProduct(
    ...
    function handleAddProductToCart(productId, product) {
